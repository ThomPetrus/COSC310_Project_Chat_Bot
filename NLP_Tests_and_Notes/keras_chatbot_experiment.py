...
print(type(train_story_text))

# Example converts each word to its matching index
...
history = model.fit([stories_train, questions_train], answers_train, batch_size=16, epochs=500, validation_data=([stories_test, questions_test], answers_test))
