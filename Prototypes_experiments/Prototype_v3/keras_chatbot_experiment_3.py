...
for article, question, answer in all_data:
...
Step 6: Fit and Train network 
    ...
    I have this set up to load the 75% accuracy model I trained. It ran for 2000 epochs
    but if you look at the graph I included it clearly platued early on at around 250 epochs.
    It's pretty neat.
...
User Input : 
    ...
    TESTER BEWAAAARREEE ~~ If you enter a word NOT in the vocabulary
    of the model it will currently throw an error. The next step will be 
    to add the list of articles and ensure that error is not thrown and
    ...
    OR of course switching to a different data set -- ?
-----------------------------------------------------------------
"""
