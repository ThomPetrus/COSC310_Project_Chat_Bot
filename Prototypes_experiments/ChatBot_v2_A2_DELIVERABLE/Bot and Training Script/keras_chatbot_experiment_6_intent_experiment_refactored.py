...
model_load_name = prev_dir + 'data/chat_bot_experiment_3000_128_dialogue_dropout_validated_on_train_v3.h5'
model_save_name = prev_dir + 'data/chat_bot_experiment_3000_128_dialogue_dropout_validated_on_train_v3.h5'
intents_model_load_name = prev_dir + 'data/chat_bot_experiment_3000_128_dialogue_dropout_validated_on_train_INTENTS_v3.h5'
intents_model_save_name = prev_dir + 'data/chat_bot_experiment_3000_128_dialogue_dropout_validated_on_train_INTENTS_v3.h5'


data_frame_load_name = prev_dir + 'data/qa_df.txt'
train_data_frame_load_name = prev_dir + 'data/qa_train_df_v3.txt'
test_data_frame_load_name = prev_dir + 'data/qa_test_df_v3.txt'

indexed_ans_list_load_name = prev_dir + 'data/qa_indexed_ans_v3.txt'

vocab_save_name = prev_dir + 'data/dialogue_vocab_v3.txt'
vocab_load_name = prev_dir + 'data/dialogue_vocab_v3.txt'
tokenizer_save_name = prev_dir + 'data/dialogue_tokenizer_v3.txt'
tokenizer_load_name = prev_dir + 'data/dialogue_tokenizer_v3.txt'
